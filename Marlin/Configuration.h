...
#define STRING_CONFIG_H_AUTHOR "(Jattie van der Linde, Creality CR-6 SE Era(v4.5.3) board)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {  80, 80, 400, 142} // 142 vs 90 - JvdL - customised for dual gear extruder
